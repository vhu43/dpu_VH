...
from evolver_manager import evolver_controls, fits
...
def main(sio: socketio.Client):
    ...
    if cal_name is not None and not get_names:
        fit, fig, raw = calibration_utils.fit_curve(
            calibration, fit_type, fit_name, params
        )
